<%@ WebHandler Language="C#" Class="llisthaj" %>

using System;
using System.Web;
using System.Data;
public class llisthaj : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context)
    {
        ...
        if (row != null)
        {
         ...
         sql += " FROM      HHajData WHERE   (DeleteOK = 0) AND (YearNo = '" + yearno + "') AND (CompanyNo = 100 OR  CompanyNo = 101) and PublicNo='"+id+"'";
